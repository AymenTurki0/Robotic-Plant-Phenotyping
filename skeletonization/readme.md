...
- **$\mathbf{W_L}, \mathbf{W_H}$**: Diagonal weight matrices balancing **contraction forces** ($\mathbf{W_L}$, pulling points inward along local curvature) and **attraction forces** ($\mathbf{W_H}$, anchoring points near their original positions).
