...
public:
  ...
  void initialize()
  {
    ...
    {
              // 在RViz中可视化轨迹
      visual_tools_.publishTrajectoryLine(my_plan.trajectory,move_group_interface_->getRobotModel()->getLinkModel("Gripping_point_Link"),joint_model_group,rviz_visual_tools::LIME_GREEN);
