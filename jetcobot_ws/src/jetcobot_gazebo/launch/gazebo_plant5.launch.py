...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={
            'gz_args': f"-r {os.path.join(gazebo_pkg, 'worlds', 'lab_world_plant5.sdf')}",
            'use_sim_time': 'false'
        }.items()
    )
  ...
  gz_topic_name: "/world/lab_world_plant5/model/jetcobot/link/6_Link/sensor/camera/image"
  ros_type_name: "sensor_msgs/msg/Image"
  gz_type_name: "gz.msgs.Image"
  direction: GZ_TO_ROS

- ros_topic_name: "/camera/camera_info"
  gz_topic_name: "/world/lab_world_plant5/model/jetcobot/link/6_Link/sensor/camera/camera_info"
